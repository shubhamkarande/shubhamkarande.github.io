...
export const projectsData = [
  ...
  },
  {
    ...
    category: 'Other',
    description: 'Implements secure user authentication by sending a One-Time Password (OTP) to verify identity during sign-up or login.',
    demoLink: 'https://web-design-showcase.com'
  },
  {
    id: 30,
  ...
  },
  {
    ...
    category: 'Other',
    description: 'A simple calculator app that performs basic arithmetic operations such as addition, subtraction, multiplication, and division with a clean UI.',
    demoLink: 'https://web-design-showcase.com'
  },
  {
    id: 33,
    ...
    title: 'Quiz App',
    category: 'Other',
    description: 'An interactive quiz application where users can answer MCQs and receive scores at the end, built with clean UI and timer support.',
    demoLink: 'https://web-design-showcase.com'
  },
  {
    id: 34,
    ...
    category: 'Other',
    description: 'Converts currency values between multiple global currencies using real-time exchange rates fetched from an API.',
    demoLink: 'https://web-design-showcase.com'
  },
  {
    id: 35,
    ...
    category: 'Other',
    description: 'Classic hand game built with interactive UI and logic to play against the computer..',
    demoLink: 'https://bloggen-demo.com'
  },
  {
    id: 36,
    ...
    title: 'Snake Game',
    category: 'Other',
    description: 'A fun arcade game where the snake grows in length by eating food and avoids collisions with itself or walls.',
    demoLink: 'https://bloggen-demo.com'
  },
  {
    id: 37,
    ...
    title: 'Tic Tac Toe',
    category: 'Other',
    description: 'A simple 2-player or player-vs-computer game with a 3x3 grid and win/draw logic implemented.',
    demoLink: 'https://brand-design-portfolio.com'
  },
  {
    id: 38,
    ...
    category: 'Other',
    description: 'A voice recognition app that converts spoken words into text using browser APIs or tools like Google Speech API.',
    demoLink: 'https://app-movil-web.com'
  },
  {
    id: 39,
    ...
    title: 'To-Do List.',
    category: 'Other',
    description: 'A basic productivity app where users can add, edit, delete, and mark tasks as complete.',
    demoLink: 'https://web-design-showcase.com'
  },
  {
    id: 40,
    ...
    title: 'Weather App',
    category: 'Other',
    description: 'Displays real-time weather information of any location using data from weather APIs like OpenWeatherMap.',
    demoLink: 'https://web-design-showcase.com'
  },
  {
    id: 41,
